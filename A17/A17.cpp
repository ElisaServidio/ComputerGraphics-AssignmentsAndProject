...
std::vector<SingleText> SceneText = {
	{3, {"1: Oren Nayar + Ambient","No specular","1 Directional Light",""}, 0, 0},
	{3, {"2: Lamber + Hemispheric","No specular","1 Directional Light",""}, 0, 0},
	{3, {"3: Spherical Harmonics","Blinn specular","4 Directional Lights",""}, 0, 0} };
...
private:
	...
	static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
		auto app = reinterpret_cast<Assignment17*>
	...
	void updateUniformBuffer(uint32_t currentImage) {
		...
		gubo.lightColor0 = glm::vec3(0.9f, 0.9f, 0.9f);
